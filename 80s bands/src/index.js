...
function getWelcomeResponse(callback) {
    ...
    var sessionAttributes = {},
        ...
        speechOutput = "I will say " + GAME_LENGTH.toString()
            + " songs from the eighties, name the band and try to get as many right as you can. Just say the answer. Let's begin. ",
