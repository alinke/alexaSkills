...
function getWelcomeResponse(callback) {
    ...
    var sessionAttributes = {},
        ...
        speechOutput = "I will say " + GAME_LENGTH.toString()
            + " actors from eighties TV shows, name the TV show that actor starred in and try to get as many right as you can. Just say the answer. Let's begin. ",
    ...
    if (!gameInProgress) {
        ...
        if (currentQuestionIndex == GAME_LENGTH - 1) {
            ...
            speechOutput += speechOutputAnalysis + "You got " + currentScore.toString() + " out of "
                + GAME_LENGTH.toString() + " questions correct. Thank you for playing eighties TV shows";
            callback(session.attributes,
...
function handleFinishSessionRequest(intent, session, callback) {
    ...
    callback(session.attributes,
        buildSpeechletResponseWithoutCard("Thanks for playing eighties TV shows!", "", true));
}
